...
# t3_start
barplot(
  Freq ~ Class + Survived, data = survival,
  beside = TRUE,  # Balken nebeneinander statt gestapelt
  horiz = TRUE,  # Waagerechte Balken
  ylim = c(0, 15),  # Y-Achsenbereich auf 0 bis 15 setzen
  main = "Weibliche Erwachsene auf der Titanic",  # Titel der Grafik
  las = 1,  # Beschriftungen Yes und No aufrecht
  legend = TRUE, args.legend = list(title = "Überlebt")
)
# t3_ende
