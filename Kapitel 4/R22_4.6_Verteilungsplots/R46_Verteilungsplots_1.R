...
# t2_start
boxplot(gesundheit$Smoker, horizontal = TRUE, ylim = c(0, 70), 
        range = 0, main = "Raucheranteil", col = "lightblue")
# t2_ende
...
boxplot(gesundheit[, 1:6], col = farben, main = "Vergleich der ersten 6 Gesundheitsvariablen")
# t3_ende
...
boxplot(Prim_Care_Phys_Rate ~ HPSA_Ind, data = gesundheit, 
        main = "Ärzte pro 100k Einwohner nach Ärztemangel", col = c("orange", "purple"))
# t4_ende
