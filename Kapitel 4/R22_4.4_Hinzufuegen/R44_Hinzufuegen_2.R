...
plot(randomWalk1, type = "l", col = "purple", lwd = 2, ylim = range(randomWalk1, randomWalk2),
     main = "Zufallsbewegung", xlab = "Schritte", ylab = "Wert")
# t3_ende
...
lines(randomWalk2, type="o", col = "blue", lty = 2, pch = 2, cex = 0.5)
# t4_ende
