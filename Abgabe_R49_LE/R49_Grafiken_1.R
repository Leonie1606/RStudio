...
plot(airquality$Temp, airquality$Ozone,
     ...
     las = 1,
     xlim = c(50, 100),
     xlab = "Temperatur  [°Fahrenheit]",
     ylab = "Ø Ozon  [ppb]",
     main = "Mehr Ozon an warmen Tagen",
     cex = airquality$Wind / 5)  # Punktgröße proportional zur Windgeschwindigkeit
...
abline(h = mean(airquality$Ozone, na.rm = TRUE), col = "red", lwd = 2, lty = 2)
# t3_ende
...
text(x = 78, y = 115, labels = "30. Mai", pos = 4, col = "black", adj=1)
# t4_ende
...
legend("topleft", legend = leg_wind, 
       pch = 16, col = "orange", 
       pt.cex = leg_wind / 5, 
